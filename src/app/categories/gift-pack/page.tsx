...
interface ProductSkeletonProps {
  // Empty interface for ProductSkeleton component
}
...
const GiftPackPage = () => {
  ...
  const fetchData = useCallback(async () => {
    ...
    // Get category info
    const categoryData = await getCategoryBySlug('gift-pack')
    ...
    if (categoryData) {
        ...
        setError('Gift Pack category not found')
      }
    } catch (error) {
      console.error('Error fetching gift pack products:', error)
    ...
    <div className="min-h-screen bg-[#222222] mt-16">
      <div className="w-full px-0 py-8 sm:py-12">
        ...
        >
          ...
          >
            Carefully curated gift sets and collections perfect for every occasion. 
            Discover premium fragrance gift packs that make unforgettable presents.
          </motion.p>
        </motion.div>
          ...
          {isLoading ? (
            ...
            >
              ...
              >
                ...
                >
                  {filterBy === 'all' ? 'No gift pack products available' : `No products match "${filterBy}" filter`}
                </motion.p>
                <motion.p 
