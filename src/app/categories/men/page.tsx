  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      if (categoryData) {
        ...
        setError('Men category not found')
      }
    } catch (error) {
...
>
  MEN&apos;S COLLECTION
          ...
          >
            Sophisticated fragrances crafted for the modern man. 
            Discover our curated collection of premium masculine scents.
          </motion.p>
        </motion.div>
          ...
          {isLoading ? (
            ...
            >
              ...
              >
                ...
                >
                  {filterBy === 'all' ? 'No men products available' : `No products match "${filterBy}" filter`}
                </motion.p>
                <motion.p 
