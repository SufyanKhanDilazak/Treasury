...
export default function SummerPage() {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      // Get category info
   // Get category info
   const categoryData = await getCategoryBySlug('summer')
   ...
   if (categoryData) {
        ...
        setError('Summer category not found')
      }
    } catch (error) {
    ...
    <div className="min-h-screen bg-[#222222] mt-16">
      <div className="w-full px-0 py-8 sm:py-12">
        ...
        >
          ...
          >
            <motion.h1 
              className="text-4xl sm:text-5xl md:text-6xl font-black text-white mb-4 bg-gradient-to-r from-orange-400 to-yellow-600 bg-clip-text text-transparent"
            ...
            <motion.div 
              className="w-24 h-1 bg-gradient-to-r from-orange-500 to-yellow-500 mx-auto mb-6"
              initial={{ width: 0 }}
              animate={{ width: 96 }}
          ...
          >
            Fresh and vibrant fragrances perfect for the warm summer season. 
            Discover light, citrusy, and refreshing scents that capture the essence of summer.
          </motion.p>
        </motion.div>
          ...
          {isLoading ? (
            ...
            >
              ...
              >
                ...
                >
                  {filterBy === 'all' ? 'No summer products available' : `No products match "${filterBy}" filter`}
                </motion.p>
                <motion.p 
