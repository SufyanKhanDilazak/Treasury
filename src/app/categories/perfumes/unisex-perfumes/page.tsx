...
// Single banner image for  collection
...
export default function NicheEssentialsPage() {
  ...
  const fetchProducts = useCallback(async () => {
   ...
   references(*[_type == "category" && title == "unisex-perfumes"]._id)
] {
  _id,
  name,
  slug,
  ...
  categories[]->{
    ...
    slug
      ...
      console.error('Error fetching unisex collection:', error)
      setError('Failed to load unisex collection')
    } finally {
      setIsLoading(false)
    }
  }, [])
            ...
            <div className="border border-blue-500 dark:border-[#a90068] bg-transparent backdrop-blur-md rounded-none sm:rounded-lg p-4 sm:p-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-5 sm:gap-6">
                {isLoading ? (
                  ...
                  <div className="col-span-full text-center py-8">
                    <p className="text-gray-500 dark:text-gray-400 text-base sm:text-lg font-light">No Unisex collection found</p>
                  </div>
                ) : (
                  memoizedProducts
                )}
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h4 className="text-2xl sm:text-3xl font-light text-gray-900 dark:text-white mb-6">
                Why Choose Our Unisex Collection
              </h4>
