...
const OudhPage = () => {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      // Get category info
     // Get category info
     const categoryData = await getCategoryBySlug('oudh')
     ...
     if (categoryData) {
        ...
        setError('Oudh category not found')
      }
    } catch (error) {
      console.error('Error fetching oudh products:', error)
    ...
    <div className="min-h-screen bg-[#222222] mt-16">
      <div className="w-full px-0 py-8 sm:py-12">
        ...
        >
          ...
          >
            Rich and luxurious oud fragrances derived from the finest agarwood. 
            Experience the deep, complex notes of authentic oudh perfumes.
          </motion.p>
        </motion.div>
          ...
          {isLoading ? (
            ...
            >
              ...
              >
                ...
                >
                  {filterBy === 'all' ? 'No oudh products available' : `No products match "${filterBy}" filter`}
                </motion.p>
                <motion.p 
